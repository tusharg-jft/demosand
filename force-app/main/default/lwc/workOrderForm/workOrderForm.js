...
import createWorkOrder from '@salesforce/apex/WorkOrderService.createWorkOrder';
import getPriorityOptions from '@salesforce/apex/WorkOrderService.getPriorityOptions';

export default class WorkOrderForm extends NavigationMixin(LightningElement) {
    // User information
    userId = Id;
    userProfileName;
